// Based on approach retrieved from: https://github.com/Microsoft/MixedRealityToolkit-Unity/blob/master/Assets/HoloToolkit/SpatialMapping/Shaders/Wireframe.shader

Shader "Unlit/Wireframe Shader"
{
	Properties
	{
